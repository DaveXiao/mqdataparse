...
public class AnalysisLogLocal extends AnalysisLogBase{
    private Long id;
    ...
    private AnalysisLogLocal() {
    }

    public AnalysisLogLocal(String user_code, Date authorize_date, Date task_begin_time, String task_state, Integer state_code, Date create_time, String remark) {
